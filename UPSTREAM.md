...
The missing working path was identified in
[`DigitalPals/fedora-config` at `6aa0744`](https://github.com/DigitalPals/fedora-config/blob/6aa074432f36548381ead91ed39d57c34529e327/roles/desktop/files/quickshell/scripts/t3-cloud.mjs).
That Quickshell module creates its own native Clerk session, requests the
