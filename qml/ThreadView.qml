...
Item {
  ...
  Column {
    ...
    Row {
      width: parent.width
      spacing: Style.spacing.md
      Button { iconText: "󰁍"; tooltipText: "Back to Inbox"; onClicked: root.backRequested() }
      Column {
        ...
        Text {
          width: parent.width
          text: root.threadData ? String(root.threadData.project) + " · " + String(root.threadData.model) + " · " + String(root.threadData.phase) : "Synchronizing with T3"
          color: Color.muted
          font.family: Style.font.family
