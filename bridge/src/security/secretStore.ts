...
export const SECRET_SERVICE_APPLICATION = "io.github.digitalpals.omarchy-t3code";
export const LEGACY_SECRET_SERVICE_APPLICATION = "io.github.omarchy-t3code";
...
export class SecretServiceStore implements SecretStore {
  ...
  constructor(
    ...
    this.legacyApplications = legacyApplications
      ?? (application === SECRET_SERVICE_APPLICATION ? [LEGACY_SECRET_SERVICE_APPLICATION] : []);
    this.tool = tool;
  }
